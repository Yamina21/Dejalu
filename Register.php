...
<div class="container">
 <div class="row">
<div  class=" left-register  col-xs-4 ">

<h1>Déjà Lu</h1>
<span>"Once you learn to read, you will be forever free."</span>
</div>
 <div  class=" Middle-Register  col-xs-8">
 <div  class="   col-xs-12"><h1>Sign Up</h1></div>
 
   <form  id="register_form" class="   col-xs-12" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" >

 <img src="layout/css/images/logo3.png"></img>
				<!-- <div class="text"><h2>Read</h2>
				 <p>for a better world</p></div></div>-->
				  <div  class="  Register-box col-xs-12">
				 <div class="login-box">
        
        <div><input type="text" id="username" name="username"  maxlength="25" autofocus placeholder="Username" required></div>
        ...
        <div><input type="email" id="email" name="email"  autofocus placeholder="E-mail" required>
            <span class="error_email" style="color: red;"></span>
			<span class="form_response" style="color: red;"></span>

		</div>
		 <div>
		     <select id="country"  name="country" class="form-control form-select form-select-sm"  aria-label=".form-select-sm example">
       ...
       <option value="Zimbabwe">Zimbabwe</option>
            ...
            <span class="error_country" style="color: red;"></span>
