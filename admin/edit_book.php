                    ...
                    ?>
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <input type="hidden" name="editbook_id" value="<?php echo $row['BookID'];?>">
                                ...
                                <input type="text" name="editb_title" value="<?php echo $row['BookName'];?>" class="form-control"
                                    placeholder="Enter Title"/>
                            </div>
                           <div class="form-group">
                                <label>Book Description</label>
                                <input type="text" name="editb_desc" value="<?php echo $row['BookDescp'];?>"
                                    class="form-control" placeholder="Enter description"/>
                            </div>
                             <div class="form-group">
                                <label>Book Writer</label>
                                <input type="text" name="editb_writer" value="<?php echo $row['writer'];?>"
                                    class="form-control" placeholder="Enter writer"/>
                            </div>
							  <div class="form-group">
                                <label>Downloads</label>
                                <input type="text" name="editb_download" value="<?php echo $row['downloads'];?>"
                            ...
                            <button type="submit" name="updatebookbtn" class="btn btn-primary"> Update </button>
